...
<%
	...
	<section class="user-page container">
		<div class="user-info">
			<div class="user-id">
				<h2><span class="user-name"><%=sessionId %></span>님 어서오세요</h2>
			</div>
			<!-- <ul class="delivery">
	...
	<section class="sell-list container">
		...
		<table class="sell-table">
	        ...
	        ArrayList<SellerBean> list = sd.getList(sessionId);
	        ...
	        %>   
		        <tr>
		            ...
		            <td><%= list.get(i).getBuyerName() %></td>
		            <td><%= list.get(i).getBuyerTel() %></td>
